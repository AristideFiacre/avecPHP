...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Information Chambre:
                                <a class="btn btn-secondary pull-right" href="index.php?room_mang">Reprogrammer Reservation</a>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Nombre de jours total : <span id="staying_day">0</span> Days</h4>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Nombre de Jours Total : <span id="staying_day">0</span> Jours</h4>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-6">
                                <label>Nom</label>
                                <input class="form-control" placeholder="Nom" id="first_name" data-error="Enter First Name" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Prenom</label>
                                <input class="form-control" placeholder="Prenom" id="last_name">
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Contact </label>
                                <input type="number" class="form-control" data-error="Enter Min 10 Digit" data-minlength="10" placeholder="Contact " id="contact_no" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="id_card_id" data-error="Select ID Card Type" required onchange="validId(this.value);">
                                    <option selected disabled>Choix Type de Carte d'identité</option>
                                    <?php
                            ...
                            <div class="form-group col-lg-6">
                                <label>Choix n° de Carte</label>
                                <input type="text" class="form-control" placeholder="n° carte d'identité" id="id_card_no" data-error="Enter Valid ID Card No" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-12">
                                <label>Adresse residentielle</label>
                                <input type="text" class="form-control" placeholder="adresse complète" id="address" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Developpé par Web Group</p>
        </div>
    </div>
